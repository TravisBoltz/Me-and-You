...
const SideBar: React.FC = () => {
  ...
  return (
    ...
    <main style={{ height: "100vh" }} onMouseEnter={() => setIsExpanded(true)} onMouseLeave={() => setIsExpanded(false)}>
      {/* // Define the sidebar */}
      <nav className={`dark:bg-gray-800 bg-white border-r-slate-600 border-r-4 ${isExpanded ? 'w-64' : 'w-16'} h-full transition-all duration-200 ease-in-out`}>
